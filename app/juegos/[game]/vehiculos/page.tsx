...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: 'Vehículos de GTA 6 - GTAVerso',
    description: 'Explora todos los vehículos disponibles en GTA 6.',
    alternates: { canonical: 'https://gtaverso.com/juegos/gta-6/vehiculos' },
  };
}
      ...
      <div className="mx-auto max-w-4xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-400">
            Explora todos los vehículos disponibles en GTA 6.
          </p>
        </div>
